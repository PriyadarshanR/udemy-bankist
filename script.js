...
const account1 = {
  ...
  movements: [200, 455.23, -306.5, 25000, -642.21, -133.9, 79.97, 1300, 1450],
  interestRate: 1.2, // %
  pin: 1111,
  ...
  movementsDates: [
    ...
    '2023-10-09T17:01:17.194Z',
    '2023-10-12T23:36:17.929Z',
    '2023-10-13T10:51:36.790Z',
    '2023-10-14T11:55:49.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const account2 = {
  owner: 'Jessica Davis',
  movements: [5000, 3400, -150, -790, -3210, -1000, 8500, -30, 145],
  interestRate: 1.5,
  pin: 2222,
...
const defaultWelcomeMessage = 'Login to get Started';
...
// console.log(new Intl.NumberFormat('en-US', options, options).format(nums));
// console.log(new Intl.NumberFormat('de-DE', options, options).format(nums));
// console.log(new Intl.NumberFormat('ar-SY', options, options).format(nums));
// console.log(new Intl.NumberFormat(navigator.language, options).format(nums));
